...
def is_winner(current_row_index, current_col_index, board):
    for direction, coordinates in DIRECTION_MAPPER.items():
        ...
        travel_direction_count = travel_direction(coordinates, current_row_index, current_col_index, searched_element, "+", board)
        travel_opposite_direction_count = travel_direction(coordinates, current_row_index, current_col_index, searched_element, "-", board)
